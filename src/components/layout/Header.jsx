...
export const Header = ({ onAdd, onUse, onEdit, isEditMode, onAddCategory, onManageSuppliers, activeView, onSignOut }) => (
    <header className="flex flex-col md:flex-row justify-between items-center mb-8">
        ...
        <div className="flex flex-wrap justify-center md:justify-end gap-3 mt-4 md:mt-0">
            ...
            <Button onClick={onSignOut} variant="danger" className="ml-4"><LogOut size={20} /> Sign Out</Button>
        </div>
    </header>
);